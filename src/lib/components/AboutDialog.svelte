<script lang="ts">
  ...
  const VERSION = '0.1.0';
  const GITHUB_URL = 'https://github.com/yourusername/tasklite';
</script>

{#if show}
  <div class="modal-overlay" onclick={onClose} role="presentation">
    <div class="modal-content" onclick={(e) => e.stopPropagation()} role="dialog" aria-labelledby="about-title">
      <div class="modal-header">
        <h2 id="about-title">{t(lang, 'about.title')}</h2>
        <button class="close-btn" onclick={onClose} aria-label={t(lang, 'about.close')}>✕</button>
      </div>
      ...
      <div class="modal-body">
        <div class="about-content">
          ...
          <div class="version-info">
            <strong>{t(lang, 'about.version')}:</strong> {VERSION}
          </div>
